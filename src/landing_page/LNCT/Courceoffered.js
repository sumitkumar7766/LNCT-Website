  ...
  <table className="table table-bordered p-1 ">
    <tbody>
      <tr>
        ...
        <td>
          Eligibility-1st Year: XII with Phy + Maths + (Chem. / Comp. Sc./Bio)
          with Min. 50% (45% for SC/ST/OBC) with qualified rank in JEE.<br />
          Eligibility-2nd Year (Direct Admission):<br />
          1. Min. 50% (45% for SC/ST/OBC) Diploma in Engg.<br />
          2. With at least 60% in B.Sc (with Maths)
        </td>
      </tr>
      <tr>
        <th>Seats</th>
  ...
  <table className="table table-bordered p-1 ">
    <tbody>
      ...
      <tr>
        ...
        <td>Advanced Communication Technology  – Based on 5G Technology (LNCT – 60 Seats)
        </td>
      </tr>
    </tbody>
  </table>,
